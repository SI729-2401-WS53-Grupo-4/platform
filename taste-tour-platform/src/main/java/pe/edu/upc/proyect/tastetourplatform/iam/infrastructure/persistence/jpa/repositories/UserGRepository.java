package pe.edu.upc.proyect.tastetourplatform.iam.infrastructure.persistence.jpa.repositories;
 ...
 */
@Repository
public interface UserGRepository extends JpaRepository<UserG, Long>
{
  /**
