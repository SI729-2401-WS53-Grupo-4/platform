...
public class UpdateTourCommandFromResourceAssembler {
    public static UpdateTourCommand toCommandFromResource(Long id, UpdateTourResource resource){
        return new UpdateTourCommand(id,resource.titleTour(),resource.description(),resource.instructor(),resource.rating(),resource.capacity(),resource.duration(),resource.date(),resource.price(),resource.restauranteId());
    }
}
