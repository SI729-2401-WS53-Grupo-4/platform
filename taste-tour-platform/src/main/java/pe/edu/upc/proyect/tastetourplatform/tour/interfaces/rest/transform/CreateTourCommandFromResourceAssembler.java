...
public class CreateTourCommandFromResourceAssembler {
    ...
    public static AddTourCommand toCommandFromResource(CreateTourResource resource){
         return new AddTourCommand(resource.titleTour(),resource.description(),resource.instructor(),resource.rating(),resource.capacity(),resource.duration(),resource.date(),resource.price(),resource.restauranteId());
    }
}
