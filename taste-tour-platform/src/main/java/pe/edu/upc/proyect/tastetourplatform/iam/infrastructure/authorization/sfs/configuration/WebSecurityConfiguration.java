package pe.edu.upc.proyect.tastetourplatform.iam.infrastructure.authorization.sfs.configuration;
...
import pe.edu.upc.proyect.tastetourplatform.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import pe.edu.upc.proyect.tastetourplatform.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
import pe.edu.upc.proyect.tastetourplatform.iam.infrastructure.tokens.jwt.BearerTokenService;
    ...
    http.csrf(csrfConfigurer -> csrfConfigurer.disable())
        ...
        .authorizeHttpRequests(
            authorizeRequests -> authorizeRequests.requestMatchers(
                "/api/v1/authentication/**","/Api/v1/TasteTour/**", "/v3/api-docs/**", "/swagger-ui.html",
